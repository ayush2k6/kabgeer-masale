  ...
  return (
    <div className="contact-page">
      ...
      <section className="contact-hero">
        ...
        <p>Have a question, business enquiry, or feedback ?</p>
        <p>We'd love to hear from you.</p>
        <p>Reach out to our team through any of the channels below.</p>
      </section>
      ...
      <section className="contact-info-section">
        <div className="contact-info-grid">
          <div className="contact-card">
            ...
            <h3>Email Us</h3>
            <a href="mailto:olympic.kabgeer@gmail.com">enquiry@kabgeermasala.com</a>
          </div>
          <div className="contact-card">
          ...
          <div className="contact-card">
            <div className="contact-page-card-icon"><WhatsAppIcon size={24} /></div>
            <h3>WhatsApp</h3>
            <a href="https://wa.me/918090086636" target="_blank" rel="noopener noreferrer">+91 80900 86636</a>
          </div>
          <div className="contact-card">
            <div className="contact-page-card-icon"><MapPin size={24} /></div>
            <h3>Visit Us</h3>
